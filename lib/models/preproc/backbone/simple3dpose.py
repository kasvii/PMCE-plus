...
from lib.models.preproc.backbone.HRnet import HRNet
...
class Simple3DPose(nn.Module):
    ...
    def forward(self, x, trans_inv, intrinsic_param, joint_root, depth_factor, flip_item=None, flip_output=False, flip_mask=None):
        ...
        #  -0.5 ~ 0.5
        # Rotate back
        pred_xyz_jts, pred_root_xy_img = self.uvd_to_cam(pred_uvd_jts, trans_inv, intrinsic_param, joint_root, depth_factor)
        ...
        return pred_xyz_jts, confidence, pred_uvd_jts_flat, pred_root_xy_img
