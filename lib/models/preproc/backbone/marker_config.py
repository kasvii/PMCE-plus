...
cfg.dataset.smpl_indices_path = 'dataset/marker/smpl_indices.pkl'
...
cfg.model.mesh2vm.vm_path = './dataset/marker'
...
cfg.model.hrnet.pretrained = 'dataset/marker/pose_hrnet_w48_384x288.pth'
...
cfg.test.weight_path = 'dataset/marker/marker_final.pth.tar'
cfg.test.vis = True
