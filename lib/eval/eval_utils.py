...
def batch_align_by_pelvis_coco(pred_j3d, target_j3d, pelvis_idxs):
    """
    Assumes data is given as [pred_j3d, target_j3d].
...
def batch_align_by_pelvis_h36m(data_list, pelvis_idxs):
    """
    Assumes data is given as [pred_j3d, target_j3d].
    Each data is in shape of (frames, num_points, 3)
    Pelvis is notated as one / two joints indices.
