...
from lib.utils.coord_utils import _box_to_center_scale, get_intrinsic_metrix, pixel2cam, cam2pixel
from lib.utils.aug_utils import get_affine_transform, augm_params
...
class DemoDataset(Dataset):
    def __init__(self, img_path_list, detection_list):
        ...
        if self.input_joint_name == 'vm':
            ...
            with open(osp.join(cfg.dataset.smpl_indices_path), 'rb') as f:
        ...
        self.joint_regressor = np.load(osp.join('dataset/marker', 'J_regressor_h36m_correct.npy'))
